const COLLECTION = 'tripcleanupjobs';
const INDEX = 'trip_cleanup_available';
const OWNER = '20260910090000-trip-cleanup-jobs';
...
export async function up(db) {
  ...
  if (existing) {
    if (
      ...
      throw new Error('Incompatible trip cleanup index');
    return;
  }
  await db
