 ...
 * improving perceived performance. Each page skeleton renders a neutral faux
 * navbar (matching the real fixed Navbar's height) plus a content placeholder
 * mirroring that page's real layout.
 */

/** Neutral placeholder matching the real fixed Navbar (h-16). */
...
/** Content-area skeleton for the stats dashboard (the Navbar is rendered by the page). */
