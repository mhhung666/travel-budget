...
| 日期 | 里程碑 |
| --- | --- |
| 09-17 | UX 優先改善第 2–7 項部署：記帳表單直接露出付款人／日期／分帳、行程頁精簡頁首與日期切換列、花費分析移到支出分頁、結算按鈕依身分改字、首頁卡片狀態與摘要、零星文案與密度；含複核發現的兩項 P2 修正。部署後未另做瀏覽器驗收。見 [改善項目紀錄](UX_IMPROVEMENTS_2026-09-17.md) |
