...
| 我的 | 旅行成就、年度回顧、設定 | 低頻個人資料不新增全域主分頁 |
| 旅行主要 | 行程、支出、相簿、結算 | 新功能優先放子頁或「更多」 |
| 行程子頁 | 每日行程、隨手記、清單 | 不與主分頁重複命名 |
| 支出子頁 | 支出明細、花費分析 | 花費分析沿用 `/trips/[id]/stats` 深連結 |
...
旅行 sticky shell 捲動 48px 後進 compact mode。支出、花費分析、結算保留金額摘要；行程、隨手記、清單、相簿可收起摘要，讓主內容更早進入首屏。
