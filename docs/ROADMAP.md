...
| AI-EXPENSE-1 | `in-progress` | [AI 自然語言記帳與分攤](./AI_IMPORT_PLAN.md#4-phase-3b自然語言記帳與分攤) | 用一句話建立可確認的支出與分攤草稿 | 文字草稿 API、付款人／全員預設及唯一姓名解析已完成；尚待四語預覽、分攤換算規則、fixture 與確認寫入串接 |
